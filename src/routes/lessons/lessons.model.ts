...
export type LessonWithPaginationType = z.infer<
  typeof LessonWithPaginationSchema
>;
...
export type LessonPaginationQueryType = z.infer<
  typeof LessonPaginationQuerySchema
>;
